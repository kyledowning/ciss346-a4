...
namespace Client
{
    public class ClientProducer
    {
        ...
        public static void SendMessage(string serverIpAddress, int port, string message, ClientForm form)
        {
            ...
            //Send the SMP packet - Produce message, append message type to message variable.
        ...
        // Process the response. Acknoledgement of a successful message production operation.
